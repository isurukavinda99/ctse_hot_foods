...
import 'package:hot_foods/screens/menu/DessertsScreen.dart';
          ...
          SafeArea(
            child: Column(
              children: [
                ...
                SizedBox(
                    height: Utill.getScreenHeight(context) * 0.6,
                          ...
                          child: Column(
                            ...
                            children: [
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      Navigator.of(context)
                                          .pushNamed(RestruantScreen.routeName);
                                    },
                                    child: Container(
                                      height: 60,
                                      width: 60,
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.of(context)
                                      .pushNamed(DessertsScreen.routeName);
                                },
                                child: MenuCard(
                                  imageShape: ClipPath(
        ...
        SizedBox(
          ...
          child: Align(
            ...
            child: Container(
              ...
              child: Image.asset(
                Utill.getAssetName("next_filled.png", "staticIcons"),
              ),
            ),
          ),
        ),
